...
import com.maya.portAuthority.speechAssets.RouteCorrector;
...
public class RouteHelper extends DataHelper {
	...
	public String putValuesInSession(Session session, Intent intent) throws InvalidInputException {
		...
		Message route = getMatchedRoute(RouteCorrector.getRoute(routeID.toUpperCase()));
		...
		session.setAttribute(NAME, RouteCorrector.getRoute(route.getRouteID()));
